...
It is based on a copy paste effort and a fresh gem build with <pre><code>bundle gem zanox</code></pre>
*Use at your own risk! It was only tested with ruby 1.9.3.*
